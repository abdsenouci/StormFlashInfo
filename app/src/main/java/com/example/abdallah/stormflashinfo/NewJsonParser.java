...
public class NewJsonParser extends AsyncTask<Void, Void, Void>
{
    ...
    public NewJsonParser(Context context)
    {
    ...
    protected Void doInBackground(Void... arg0)
    {
        ...
        if (ListLieu != null || ListBonPlan != null || ListHoraire != null)
        {
            ...
            DataListes.setLieux(ListLieu);
            DataListes.setBonPlans(ListBonPlan);
            DataListes.setHoraires(ListHoraire);
        }
        return null;
    }
}
